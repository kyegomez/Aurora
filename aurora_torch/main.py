...
class LocalAttention(nn.Module):
    def __init__(
        self, dim, heads=8, dim_head=64, dropout=0.0, patch_size=7
    ):
        super().__init__()
...
class GlobalAttention(nn.Module):
    def __init__(self, dim, heads=8, dim_head=64, dropout=0.0, k=7):
        ...
        self.to_kv = nn.Conv2d(
            dim, inner_dim * 2, k, stride=k, bias=False
        )
